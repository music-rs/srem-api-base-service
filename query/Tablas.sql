...
select * FROM SREMEVENTO order by EVEN_ID;
select * FROM SREMPARGEN;
select * FROM SREMUSUAIN where USUA_NICKN='N' order by USIN_VALOR desc;
SELECT * FROM SREMUSUARi;

SELECT * FROM SREMEVENTO WHERE EVEN_NOMBR='LIMA';

SELECT * FROM SREMUSUAIN where EVEN_NOMBR='LIMA'; EVEN_ID='5536';

DELETE FROM  SREMUSUAIN where EVEN_NOMBR='LIMA';
DELETE FROM SREMEVENTO WHERE EVEN_NOMBR='LIMA';
DELETE FROM SREMUSUARi WHERE USUA_NICKN = 'N';
DELETE FROM SREMUSUAIN where USUA_NICKN='N';

select count(*) from SREMUSUAIN;
select * from SREMUSUAIN order by 1;
...
update SREMUSUAIN set USUA_ID='507' where  USUA_ID='506';


desc SREMUSUARI;

desc SREMUSUAIN;
select SREMUSUAIN_SEQ.NEXTVAL from dual;
select * from SREMUSUAIN order by 1 desc;

select EVEN_NOMBR, count(*) from SREMEVENTO group by EVEN_NOMBR order by count(*) desc;
--delete from SREMUSUAIN where USIN_ID >= 2717;

--drop table SREMUSUARI;
--delete from SREMUSUARI;
--